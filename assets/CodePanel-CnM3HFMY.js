import{m as s,k as e}from"./react-vendor-BeqvafmB.js";import{_ as m,b9 as p,C as g,m as u,P as x,F as b,U as f}from"./icons-DpLmz3K_.js";function h(){const[t,n]=s.useState("load"),[a,r]=s.useState(null),d=(i,o)=>{navigator.clipboard.writeText(i),r(o),setTimeout(()=>r(null),2e3)},l=[{id:"load",label:"Load GloVe",icon:m},{id:"use",label:"Use Embeddings",icon:p},{id:"train",label:"Train Custom",icon:g},{id:"visualize",label:"Visualization",icon:u}],c={load:[{title:"Load Pre-trained GloVe (Manual)",code:`import numpy as np

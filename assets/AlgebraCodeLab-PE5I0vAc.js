const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/algebraCodeLabs-ChroE2jL.js","assets/index--Y7eYyBB.js","assets/react-vendor-Cdu38Wyn.js","assets/router-D1rsdnJA.js","assets/icons-BEfsDuMg.js","assets/assessment-data-BEcQsvEZ.js","assets/glossary-data-DT2DBpOJ.js","assets/index-0Zls5frI.css","assets/CodeFixLab-CL-iaCzS.js"])))=>i.map(i=>d[i]);
import{_ as d}from"./index--Y7eYyBB.js";import{k as i,j as l}from"./react-vendor-Cdu38Wyn.js";import{C as p}from"./CodeFixLab-CL-iaCzS.js";const h=[{id:"dot-product-first-pair",stepLabel:"1.1",group:"Dot product",title:"First matching pair",concept:"A dot product starts by multiplying entries with the same index. The first contribution comes from multiplying the two index-0 entries.",objective:"Replace one expression with the current aligned pair product inside the full matmul function.",difficulty:"warmup",starterCode:`/**
...
}`,explanation:"The pseudoinverse gives a least-squares or minimum-norm solution when an ordinary inverse is unavailable."}],m={"matrix-multiplication":["Dot product","Matrix cell","Matrix multiplication","Shape compatibility"]};function f(t){const e=m[t];if(!e)return null;const r=new Set(e);return h.filter(n=>r.has(n.group))}function g({exercises:t,lessonId:e,progressScopeId:r}){const[n,u]=i.useState(null),o=i.useMemo(()=>e?f(e):null,[e]);i.useEffect(()=>{if(t||o)return;let c=!0;return d(async()=>{const{ALGEBRA_CODE_LABS:a}=await import("./algebraCodeLabs-ChroE2jL.js");return{ALGEBRA_CODE_LABS:a}},__vite__mapDeps([0,1,2,3,4,5,6,7,8])).then(({ALGEBRA_CODE_LABS:a})=>{c&&u(a)}),()=>{c=!1}},[t,o]);const s=t||o||n;return s?l.jsx(p,{exercises:s,progressScopeId:r||e}):l.jsx("div",{className:"flex items-center justify-center p-12 text-sm text-slate-500",children:"Loading code lab..."})}const y=Object.freeze(Object.defineProperty({__proto__:null,default:g},Symbol.toStringTag,{value:"Module"}));export{m as A,h as L,y as a,f as g};

import { P0_ATTENTION_SCENARIOS_BY_LESSON } from './p0AttentionScenarioQuestions.js';
import { P0_DEEP_LEARNING_LOSS_OUTPUT_SCENARIOS_BY_LESSON } from './p0DeepLearningLossOutputScenarioQuestions.js';
...
import { P0_TRANSFORMER_ARCHITECTURE_SCENARIOS_BY_LESSON } from './p0TransformerArchitectureScenarioQuestions.js';
...
import { P1_NUMERICAL_LINEAR_ALGEBRA_APPLIED_SCENARIOS_BY_LESSON } from './p1NumericalLinearAlgebraAppliedScenarioQuestions.js';
import { P1_PROBABILITY_REASONING_APPLIED_SCENARIOS_BY_LESSON } from './p1ProbabilityReasoningAppliedScenarioQuestions.js';
...
export const ASSESSMENT_SCENARIO_EXTENSION_SOURCES = Object.freeze([
  ...
  Object.freeze({ id: 'p0-attention', priority: 'P0', questionsByLesson: P0_ATTENTION_SCENARIOS_BY_LESSON }),
  Object.freeze({ id: 'p0-deep-learning', priority: 'P0', questionsByLesson: P0_DEEP_LEARNING_SCENARIOS_BY_LESSON }),
  Object.freeze({ id: 'p0-deep-learning-loss-output', priority: 'P0', questionsByLesson: P0_DEEP_LEARNING_LOSS_OUTPUT_SCENARIOS_BY_LESSON }),

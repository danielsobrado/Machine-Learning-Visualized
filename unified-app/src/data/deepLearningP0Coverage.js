...
export const DEEP_LEARNING_P0_REQUIREMENTS = Object.freeze([
  ...
  competency(
    'loss-output-logits-vs-probabilities',
    'loss-functions-likelihoods',
    ['losslik-044-probability-output', 'losslik-063-scenario-logits'],
    ['loss-output-logits-api-contract'],
    1,
  ),
  competency(
    'loss-output-bce-vs-categorical-ce',
    'loss-functions-likelihoods',
    ['losslik-015-binary', 'losslik-016-multiclass'],
    ['loss-output-bce-vs-ce-task-structure'],
    1,
  ),
  competency(
    'loss-output-softmax-semantics',
    'loss-functions-likelihoods',
    ['losslik-028-softmax-ce', 'losslik-052-scenario-class'],
    ['loss-output-softmax-vs-independent-labels'],
    1,
  ),
  competency(
    'loss-output-numerical-stability',
    'loss-functions-likelihoods',
    ['losslik-022-log-stability', 'losslik-045-logits'],
    ['loss-output-fused-loss-numerical-stability'],
    1,
  ),
  competency(

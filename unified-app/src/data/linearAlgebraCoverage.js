...
export const LINEAR_ALGEBRA_COVERAGE = Object.freeze({
  ...
  'fundamental-subspaces': requirement(['subspaces-consistency-diagnosis-worked']),
  'matrix-decompositions': requirement(['decomp-structure-cost-decision']),
  'qr-decomposition': requirement(['qr-least-squares-worked']),
  svd: requirement(['svd-energy-rank-selection-worked']),
});
...
export const LINEAR_ALGEBRA_DEPTH_REQUIREMENTS = Object.freeze([
  ...
  depthRequirement('left-null-space-consistency-diagnosis', 'fundamental-subspaces', ['subspaces-consistency-diagnosis-worked']),
  depthRequirement('decomposition-structure-cost-decision', 'matrix-decompositions', ['decomp-structure-cost-decision']),
  depthRequirement('qr-least-squares-back-substitution-calculation', 'qr-decomposition', ['qr-least-squares-worked']),
  depthRequirement('svd-energy-rank-selection-calculation', 'svd', ['svd-energy-rank-selection-worked']),
]);
